...
const sections = [
  ...
  [
    ...
    { id: 'locations', label: 'Claim a Castle!' },
    { id: 'polls', label: 'Member Polls' }
  ],
  // Second row
  [
    { id: 'platforms', label: 'Society Platforms' },
    { id: 'documents', label: 'Documentation and Forms' },
    { id: 'resources', label: 'Historical Resources' },
    { id: 'officers', label: 'Society Officers' }
  ]
];
...
export function QuickLinks() {
  const scrollToSection = (id: string) => {
    ...
    if (element) {
      // Increased offset for mobile to account for the sticky header
